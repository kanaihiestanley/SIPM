...
const CreateYTLiveStreamPost = () => {
  ...
  const addLiveStreamPost = async (newPost) => {
    try {
      const response = await axios.post('http://localhost:4000/api/livestreamposts/', newPost);
...
export default CreateYTLiveStreamPost;
