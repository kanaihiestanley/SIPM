...
// //         if (isConfirmed) {
// //             try {
// //                 await axios.delete(`http://localhost:5005/api/gallery/${GalleryPost.id}`);
...
// //               `http://localhost:5005/api/gallery/${GalleryPost.id}`, 
// //               formData,
...
// //                         <div className="mb-3">
// //                             <label className="form-label fw-bold">Current Images ({editedPost.images.length}):</label>
...
// //                     <div className="mb-3">
// //                         <label className="form-label fw-bold">Add New Images:</label>
// //                         <input
// //                             type="file"
// //                             className="form-control"
// //                             multiple
...
// //                         <div className="mb-3">
// //                             <label className="form-label fw-bold">New Images Preview ({newImagePreviews.length}):</label>
// //                             <div className="row">
...
// //                     <p><strong>📝 Description: </strong>{GalleryPost.description || 'No description provided'}</p>
                    
// //                     {/* Display multiple images */}
// //                     {galleryImages.length > 0 && (
// //                         <div className="mb-3">
// //                             <strong>🖼️ Images ({galleryImages.length}):</strong>
// //                             <div className="row mt-2">
...
// //                                             className="img-fluid"
// //                                             onClick={() => window.open(`http://localhost:5005${imageUrl}`, '_blank')}
...
// //                     <p>
// //                         <small>
// //                             📅 Created: {new Date(GalleryPost.created_at).toLocaleString()}
// //                             {GalleryPost.updated_at && GalleryPost.updated_at !== GalleryPost.created_at && 
// //                                 ` | ✏️ Updated: ${new Date(GalleryPost.updated_at).toLocaleString()}`
// //                             }
// //                         </small>
// //                     </p>
...
// //                                 ℹ️ You have view-only access. Contact admin for edit/delete permissions.
// //                             </small>
// //                         )}
// //                     </div>
// //                     <hr />
...
//                         {hasPermission('edit') && (
//                             <button className="btn btn-secondary" onClick={handleEdit}>
//                                 <span role="img" aria-label="info">ℹ️</span> You have view-only access
//                             </button>
//                         )}
