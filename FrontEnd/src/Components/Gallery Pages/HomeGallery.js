...
//     setError(null);
//     try {
//       const response = await axios.get('http://localhost:5005/api/gallery');
...
//     // Permission check is inside GalleryDetails
//     const isConfirmed = window.confirm('Are you sure you want to delete this gallery?');
//     if (isConfirmed) {
//       try {
//         await axios.delete(`http://localhost:5005/api/gallery/${postId}`);
...
//             <strong>👤 Logged in as:</strong> {hasPermission('delete') ? 'Admin (Full Access)' : 'User (Create & View Only)'}
//           </div>
//         )}
